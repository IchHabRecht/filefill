...
call_user_func(function () {
    // @deprecated Can be removed once support for TYPO3 < 12 is dropped
    // Use IchHabRecht\Filefill\EventListener\ModifyFlexFormDataStructureEventListener as replacement
